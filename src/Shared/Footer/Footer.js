    ...
    return (
        <div >
            <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div class="md:flex md:justify-around">
                    <div class="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            ...
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">HR Manager</span>
                        </a>
                    </div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between lg:px-36">
