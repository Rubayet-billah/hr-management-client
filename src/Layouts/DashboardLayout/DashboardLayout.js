...
const DashboardLayout = () => {
    return (
        <div>
            ...
            <div id="drawer-navigation" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 border" tabindex="-1" aria-labelledby="drawer-navigation-label">
