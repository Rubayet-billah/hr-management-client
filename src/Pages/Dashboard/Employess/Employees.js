        ...
        <div>
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {
                            employees.map(employee => <tr key={employee._id} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="p-4 w-4">
                                    <div class="flex items-center">
                                ...
                                <th scope="row" class="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src={employee.image} alt={employee.fname} />
                                    <div class="pl-3">
                                        <div class="text-base font-semibold">{employee.fname + ' ' + employee.lname}</div>
