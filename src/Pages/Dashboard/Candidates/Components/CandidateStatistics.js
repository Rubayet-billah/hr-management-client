...
const CandidateStatistics = ({ candidates, shortlistedCandidates, showShortlistedCandidate, setShowShortlistedCandidates, refetch }) => {
    return (
        <div>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
                ...
                <div onClick={() => {
                    ...
                    <div>
                        ...
                        <p className='text-3xl font-medium text-gray-700'>{shortlistedCandidates?.length}</p>
                    </div>
                    <BiBarChart className='text-5xl text-gray-700' />
                </div>
            </div>
