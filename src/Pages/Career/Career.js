        ...
        <div className='bg-white rounded shadow p-5 mb-5'>
          ...
          <form onSubmit={handleSubmit(handleApplierForm)} className='flex flex-col gap-4'>
            ...
            <div className='grid lg:grid-cols-2 gap-4'>
              ...
              <div>
                <label className='text-bold' htmlFor='applyDate'>
                  ApplyDate
                </label>
                <TextInput
                  id='applyDate'
              ...
              <div>
                <label className='text-bold' htmlFor='apply-for'>
                  What position are you applying for?
                </label>
                <Select id='apply-for' {...register('designation', { required: true })} sizing='sm'>
              ...
              <div>
                <label className='text-bold' htmlFor='Job-type'>
                  Job Type{' '}
                </label>
                <Select id='Job-type' {...register('jobType', { required: true })} sizing='sm'>
            ...
            <div className='my-4'>
              <div className='my-4'>
                ...
                <Textarea {...register('hiringReason')} placeholder='Add a Node...' rows={4} className='text-xs' />
              </div>
              <div>
                <h1>CoverLetter</h1>
                <Textarea
